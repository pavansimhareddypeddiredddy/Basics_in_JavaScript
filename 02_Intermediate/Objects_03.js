...
// MERGING OF THE OBJECTS
  // (1) Using Object.assign(object1,object2) 
   const  object1 = {1:"a", 2: "b"};
  const object2 = { 2:"c" , 3: "d"};
  // here the first object acts as the target , once merging done both target object and the merged object as the same key value pairs
  // if there are same keys in different objects , it takes only one key and the latest value of that key
  const mergedObject = Object.assign(object1, object2);
  console.log(mergedObject);
  console.log(`is mergedObject and Object1 are same ? ${mergedObject===object1}`);

  //(2) Using Object.spread(...object1,...object2)
const object3 = {4: "e", 5:"f"};
const object4 = {6: "g" , 7: "h"};
  const mergedObjectUsingSpread = {...object3,...object4};
  console.log(mergedObjectUsingSpread === object3);// false because here all the objects are sources.


// ACCESSING KEYS, VALUES AND BOTH(KEYS AND VALUES) IN OBJECTS

  console.log(Object.keys(object1));  // return the all the keys of the specified object in array form
  console.log(Object.values(object1));   // returns the all the values of the specified object in array form
  console.log(Object.entries(object1));  // returns both key value pairs of the specified object in array form

// hasOwnProperty() is used to check wheather the specified key is inside the object or not
 console.log(object4.hasOwnProperty('6'); // true because we have key value of 6 in object4. 
